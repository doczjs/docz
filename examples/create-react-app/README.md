# create-react-app docz example

> Note that the create-react-app README was modified :
...
[PR](https://github.com/facebook/create-react-app/pull/7668) to create-react-app. 
